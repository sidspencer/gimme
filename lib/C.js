 ...
 */
static class WinProp {
    // For singleton static class instances.
 ...
 */
static class FileEntryStateClass {
 ...
 */
static class AccessWay {
    // Bare protocol names.
    static HTTP = 'http';
    static HTTPS = 'https';
    static CH = 'chrome-extension';
    static FILE = 'file';
    static FTP ='ftp';
    ...
    static CH_CWW = AccessWay.CH + AccessWay.CWW;
 ...
 */
static class SelectorProperties {
    // Selector Props
    static SCOPE = ':scope';
    static HREF = 'href';
    static SRC = 'src';
...
/**
 * Constnt for CSS static class names.
 */
static class CssClassName {
    static OPT = 'opt';
    static PHOTO = 'photo';
}
 ...
 */
static class DiggerConfiguration {
    static BATCH_SIZE = 3;
    static CHANNELS = 11;
}
 ...
 */
static class LogickerConfiguration {
 ...
 */
static class UtilsConfiguration {
 ...
 */
static class FileNamingConstants {
 ...
 */
static class PostProcessingVerb {
    static REPLACE = 'replace';
}


/**
 * Static static class for holding the constants regarding options. The
 ...
 */
static class DominatrixConfiguration {
...
/**
 * static class for default values, sundry extensions.
 */
static class BlankValue {
    static LOCALHOST = 'localhost';
    static LOC = new URL(`${AccessWay.HTTP_CWW}${BlankValue.LOCALHOST}${StringToken.WHACK}`);
...
/**
 * Static static class for the values of our page names.
 */
 ...
 */
static class CannedFunctions {
    static E = ((one, two, three, four, five, six, seven, eight, nine, ten) => {});
    
    static PR_RJ = ((payloadIn, outVal) => { 
        return Promise.reject((!!outVal ? outVal : BlankValue.PR_RJ)); 
    });
    
    static PR_RS = ((payloadIn, outVal) => { 
        return Promise.resolve((!!outVal ? outVal : BlankValue.PR_RJ)); 
    });
    
    static PR_RJ_STOP = (() => {
        return Promise.reject(Action.STOP);
    });
    ...
    static PR_RJ_DEF = (() => {
        return Promise.reject(BlankValue.PR_RJ);
    });
    
    static PR_RS_DEF = (() => {
        return Promise.resolve(BlankValue.PR_RS)
    });
}
